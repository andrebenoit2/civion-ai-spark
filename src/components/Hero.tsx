      ...
      <div className="relative max-w-7xl mx-auto text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            Launch personalized SMS and WhatsApp campaigns in minutes. 
            <strong className="text-gray-900"> No manual agents required.</strong> 
            Civion's AI engine handles everything from lead qualification to appointment scheduling.
          </p>
